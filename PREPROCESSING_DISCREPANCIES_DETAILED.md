...
## Purpose
The supervisor asked us to analyse preprocessing differences more finely to
find discrepancies (beyond interpolation) that may explain the RMSE gap to
the literature. This document identifies five discrepancies, ranked by
likely impact.

## Our Current Preprocessing (from code)
